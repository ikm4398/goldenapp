...
#         att.*,
#         ROW_NUMBER() OVER (
#             PARTITION BY att.employee, att.attendance_date
#             ORDER BY 
#                 CASE WHEN att.in_time IS NOT NULL THEN 0 ELSE 1 END,
#                 att.modified DESC
#         ) as rn
...
#                     LIMIT 1
#                 )
#                 WHEN att.in_time IS NOT NULL AND TIME(att.in_time) >= '20:00:00' AND next_att.out_time > att.in_time THEN next_att.out_time
#                 ELSE NULL
#             END
#         )
#     END AS out_time,
...
#                                 LIMIT 1
#                             )
#                             WHEN TIME(att.in_time) >= '20:00:00' AND next_att.out_time > att.in_time THEN next_att.out_time
#                             ELSE NULL
#                         END,
#                         NULL
#                     )
